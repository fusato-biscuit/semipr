...
class SeminarForm(forms.ModelForm):
    class Meta:
        model = Seminar
        fields = ['semi_name', 'department', 'teach_name', 'mail', 'area_of_seminar', 'semi_schedule', 'seni_men_num', 'seni_women_num', 'juni_men_num', 'juni_women_num', 'feature', 'visitable_date', 'on_offline', 'message_for_sutudent', 'semi_image1', 'semi_image2', 'semi_image3', 'semi_image4', 'semi_image5', 'semi_image6']
